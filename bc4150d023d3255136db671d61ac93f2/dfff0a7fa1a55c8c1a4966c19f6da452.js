...
async function handleCommand(command) {
    ...
    if (command === "help") {
        ...
        await typewriterEffect("Deltascape OS v5.3\n");
        await typewriterEffect("------------------------------------------------------------\n\n");
        ...
        await typewriterEffect("20 54 68 65 20 63 6C 75 65 73 20 61 72 65 20 68 65 72 65 2E 0A 0A 38 73 35 70 70 36 34 33 30 36 \n");
        await typewriterEffect("31 33 73 31 70 31 32 73 33 36 39 36 35 30 35 30 6F 6F 37 31 39 37 2E 7A 71 35 0A 0A 54 68 61 74 \n");
